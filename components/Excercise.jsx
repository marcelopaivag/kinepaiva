                ...
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:flex lg:items-center">
                        <div className="w-full space-y-12 lg:w-1/2 ">
                            <div>
                                <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Beneficios del <br />Ejercicio terapéutico para tu recuperación</h1>
                                ...
                                <p className="mt-3 text-gray-500 dark:text-gray-300">
                                    El ejercicio es un subconjunto de la actividad física y se define como la actividad estructurada con el objetivo de mejorar el rendimiento físico y/o la salud.
                                    En las últimas dos décadas se ha acumulado un conocimiento considerable sobre la importancia del ejercicio como tratamiento de primera línea de varias enfermedades.
                                </p>
